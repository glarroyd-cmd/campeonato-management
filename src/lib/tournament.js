...
const WC2026_GROUPS = [
  ...
  { letter: 'E', teams: [
    ...
    { name: 'Coreia do Norte', flag: '🇰🇵', pot: 2 },
    { name: 'Jordânia',        flag: '🇯🇴', pot: 3 },
    { name: 'Suécia',          flag: '🇸🇪', pot: 4 },
  ]},
  { letter: 'F', teams: [
    { name: 'Inglaterra',      flag: '🏴󠁧󠁢󠁥󠁮󠁧󠁿', pot: 1 },
    { name: 'Senegal',         flag: '🇸🇳', pot: 2 },
    { name: 'Curaçao',         flag: '🇨🇼', pot: 3 },
